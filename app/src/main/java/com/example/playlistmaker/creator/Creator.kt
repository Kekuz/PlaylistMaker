...
object Creator {
    ...
    private fun getNightModeRepository(): SettingsRepository {
        return SettingsRepositoryImpl(SharedPrefSettingsStorage(appContext))
    }

    fun provideNightModeInteractor(): SettingsInteractor {
        return SettingsInteractorImpl(getNightModeRepository())
    }
